...
search.addEventListener("click", () => {
  ...
  if (window.innerWidth >= 768) {
    if (header.classList.contains("scrolled-header")) {
      ...
      header.classList.contains("cp-header-with-banner") &&
      header.classList.contains("typ-transparent")
    ) {
      global_search_section.style.top = "80px";
    } else {
      global_search_section.style.top = "70px";
    }
  }
